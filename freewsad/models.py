...
class Book(models.Model):
    ...
    author = models.CharField(max_length=50, verbose_name=_("Author name"), null=True, blank=True)
    author_id = models.ForeignKey(Author, on_delete=models.CASCADE, null=True, blank=True)
    category = models.ForeignKey(BookCategory, on_delete=models.CASCADE, null=True, verbose_name=_("Category"))
    language = models.ForeignKey(Language, on_delete=models.CASCADE ,blank=True, null=True, verbose_name=_("Language"))
    type = models.ForeignKey(Type, on_delete=models.CASCADE, null=True, blank=True, verbose_name=_("Type"))
